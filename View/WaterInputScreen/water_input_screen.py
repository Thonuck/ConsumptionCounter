...
class WaterInputScreenView(BaseAppScreenView):
    ...
    def __init__(self, **kwargs):
        ...
        layout.add_widget(self.create_top_bar(title="Water Input"))
    ...
    def add_input_widgets(self):
        ...
        self.datum_text_field = MDTextField(id='datum',
                                       hint_text='Datum',
                                       font_size='24sp')
        item_layout.add_widget(self.datum_text_field)

        self.time_text_field = MDTextField(id='time',
                                       hint_text='Time',
                                       font_size='24sp')
        item_layout.add_widget(self.time_text_field)

        self.stand_text_field = MDTextField(id='stand',
                                       hint_text='Stand',
                                       font_size='24sp')
        item_layout.add_widget(self.stand_text_field)
    ...
    def get_data(self):
        return {'datum': self.datum_text_field.text,
                'time':  self.time_text_field.text,
                'stand': self.stand_text_field.text}
